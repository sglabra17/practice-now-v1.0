const videos = {
    basico : [
        {   
            ...
            url   : '<iframe width="560" height="315" src="https://www.youtube.com/embed/erjMgola4fQ?si=VZ_QsAUKr7H9lIVP" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>'
        },
        {
            title : 'Cooking',
            url   : '<iframe width="560" height="315" src="https://www.youtube.com/embed/uVGV8LG3HHM?si=9F1hOYmmoXbI-kAf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>'
        },
        {
            title : 'Weather',
...
for (const video of videosArr) {
    ...
    vidCtnr.innerHTML = `<h1 class="formHeader">Video ${contador} - <span class="videoName">${video['title']}</span></h1>${video['url']}`;
